 ...
 *
 * $Id: _pm_src_picker.tpl,v 1.2 2005/02/19 16:53:35 filetreefrog Exp $
 *}
		...
		<table width="100%" cellpadding="0" cellspacing="3" border="0" class="container_editheader">
			<tr>
				...
				<td align="right" valign="top">
					...
					Import Into This Weblog Module
					</a>
					{/if}
				</td>
			</tr>
