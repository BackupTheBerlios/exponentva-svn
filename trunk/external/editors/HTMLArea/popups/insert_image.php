<?php
define("SCRIPT_EXP_RELATIVE","external/editors/HTMLArea/popups/");
define("SCRIPT_FILENAME","content_linked.php");

include_once("../../../../pathos.php");
?>
<html><head>  <title>Insert Image</title><script type="text/javascript" src="popup.js"></script><script type="text/javascript">
...
function onBrowse() {
	window.open("../../../../modules/filemanagermodule/actions/picker.php?id=0");
	return;
