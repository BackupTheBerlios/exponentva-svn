...
return array(
	...
	'use_lang_desc'=>'In welcher Sprache soll Exponent angezeigt werden?',
	...
	'site_description_desc'=>'Geben Sie hier eine möglichst präzise Beschreibung Ihre
	Webauftritts ein.',
	
	'site_404'=>'"Nicht gefunden" Fehlertext',
	'site_404_desc'=>'Der Benutzer bekommt diese HTML-Nachtricht angezeigt, wenn eine Seite oder ein Inhalt nicht gefunden wird. Ersetzen Sie den vorgegebenen Text mit ihrem eigenen',
	
	'site_403'=>'"Zugriff verweigert" Fehlertext',
	'site_403_desc'=>'Der Benutzer bekommt diese HTML-Nachricht angezeigt, wenn er versucht ein Aktion auszuführen,  für die er nicht die notwendige Berechtigung besitzt. Ersetzen Sie den vorgegebenen Text mit ihrem eigenen',
	
	'default_section'=>'Start Bereich',
	'default_section_desc'=>'Startseite von Exponent. Wählen Sie aus der Auflistung den Bereich Ihres Webauftritts der als erster im Browser erscheinen soll, wenn ihre URL eingeben wird ',
	...
	'timeout_error_desc'=>'Der Benutzer bekommt diese HTML-Nachricht angezeigt, wenn seine Verbindung wegen Zeitüberschreitung getrennt wurde. Ersetzen Sie den vorgegebenen Text mit ihrem eigenen',
