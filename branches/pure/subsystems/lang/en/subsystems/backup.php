...
#
# $Id: backup.php,v 1.6 2005/02/19 00:35:12 filetreefrog Exp $
##################################################
...
define('TR_BACKUPSUBSYSTEM_DATADEFNOTFOUND',		'Table "%s" not found in the system (line %s)');

define('TR_BACKUPSUBSYSTEM_INVALIDTYPE',			'Invalid type on line %s');
define('TR_BACKUPSUBSYSTEM_NOTREADABLE',			'Unable to read EQL file');
